    ...
    <div className="text-center animate-fade-in py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto">
        <button
          ...
          className="p-8 rounded-xl shadow-lg transition-all transform hover:-translate-y-2 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-text-accent focus:ring-offset-brand-bg bg-brand-container hover:bg-gray-700"
        >
